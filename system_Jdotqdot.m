...
R_lower = 0.2256; 
A_P = [ ...
   -0.0932   -0.2233   -0.0624;
   -0.1869   -0.1983   -0.0569;
   -0.2430    0.0592   -0.0657;
   -0.1686    0.1323   -0.0580;
    0.0787    0.0538   -0.0657;
    0.0976   -0.0441   -0.0580];

% B 点：表达在 {G} (下平台/世界) 坐标系
B_G = [ ...
    0.1068   -0.2107    0.0363;
   -0.1943   -0.1161    0.0507;
   -0.2224    0.0040    0.0429;
    0.0117    0.2182    0.0487;
    0.1231    0.1865    0.0418;
    0.1904   -0.1230    0.0501];
